...
struct thread
  {
    ...
    int64_t ticks_wake;                 /* The rest ticks the thread should be waken up*/
    ...
    int exit_code;                      /* For terminating message */

    tid_t parent_tid;                   /* tid for parent */
    struct list child_thread_list;      /* thread list for children */
    ...
    struct hash supp_page_table;       /* The SPT which stores some information about a page */
#endif
...
/* Element of list child_threads for USERPROG */
struct child_status
{
